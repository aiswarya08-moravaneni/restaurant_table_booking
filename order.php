...
<html lang="en">
  ...
  <body>
    ...
    <section id="booking-section" class="container">
      <h2 class="text-center mt-5">Book a Table</h2>
      <form action="table_booking.php" method="POST" class="mt-4">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="guests" name="guests" placeholder="Enter number of guests" min="1" required />
        </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Sample output confirmation - You can replace this with code to insert into a database or send via email
